...
from .udasegdataset import UDA_Dataset_ISPRS
## added by LYU: 2024/08/12
from .cityosm import UDA_Dataset_CITYOSM
...
__all__ = [
    ...
    'NYUDataset', 'HSIDrive20Dataset', 'UDA_Dataset_ISPRS', 'UDA_dataset_CITYOSM'
]
